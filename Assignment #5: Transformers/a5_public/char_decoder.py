...
class CharDecoder(nn.Module):
    ...
    def forward(self, input, dec_hidden=None):
        ...
        hidden, dec_hidden = self.charDecoder(char_embed, dec_hidden)

        score = self.char_output_projection(hidden)
    ...
    def train_forward(self, char_sequence, dec_hidden=None):
        ...
        loss = nn.CrossEntropyLoss(ignore_index=self.target_vocab.char2id['∏'])
